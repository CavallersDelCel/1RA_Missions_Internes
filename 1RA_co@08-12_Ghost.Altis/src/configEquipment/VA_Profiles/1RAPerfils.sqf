...
//                                                                                                       //
// Changes: 1.0   (26/12/2013) Document inicial per CC_OMSmolina, CC_TBlack i CC_Viper.                  //
...
//                            confirmació a l'hora de desar els perfils per Magnetar   .                 //
//         3.4   (26/04/2015) Afegit el perfil anti-aèri per Magnetar   , actualitzats els perfils de    //
...
//                            la versió 0.3.8 de RHS per Magnetar    i CC_Viper.                         //
