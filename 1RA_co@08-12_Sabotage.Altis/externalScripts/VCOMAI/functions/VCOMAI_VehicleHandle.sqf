...
private ["_Unit", "_myNearestEnemy", "_UnitSide", "_SideCheck", "_UnitGroup", "_GroupUnits", "_Vehicle", "_CargoList", "_waypoint0", "_ClosestUnit", "_ResetWaypoint","_GroupArray"];
//Created on ???
...
if ((count (waypoints _UnitGroup)) < 2) then
{
	...
	_Unit spawn VCOMAI_FlankManeuver;
	
	_Unit spawn 
	{
		sleep 300;
		_this setVariable ["VCOM_FLANKING",false,false];
	};
