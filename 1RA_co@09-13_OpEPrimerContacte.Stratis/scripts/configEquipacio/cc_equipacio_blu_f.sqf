...
switch (_tipusUnitat) do
{
	...
	case "box":
	{
		...
		_unitat addWeaponCargoGlobal [_armaDM,1];
		_unitat addItemCargoGlobal [_armaSilenciador,3];
		...
		_unitat addItemCargoGlobal [_armabipodeDM, 1];
		_unitat addWeaponCargoGlobal [_armaLlencadorAT,2];
		_unitat addWeaponCargoGlobal [_armaLlencadorRF,2];
		_unitat addWeaponCargoGlobal [_armaLlencadorAA,1];
		_unitat addMagazineCargoGlobal ["rhs_fgm148_magazine_AT",6];
		_unitat addMagazineCargoGlobal ["rhs_m136_hedp_mag",2];
		_unitat addMagazineCargoGlobal ["rhs_fim92_mag",4];
		_unitat addMagazineCargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_Stanag",30];
		_unitat addMagazineCargoGlobal ["rhs_mag_m67",10];
		_unitat addMagazineCargoGlobal ["rhsusf_100Rnd_556x45_soft_pouch",15];
		_unitat addMagazineCargoGlobal ["SatchelCharge_Remote_Mag",2];
		_unitat addMagazineCargoGlobal ["rhs_mag_M433_HEDP",20];
		_unitat addMagazineCargoGlobal ["rhsusf_20Rnd_762x51_m118_special_Mag",20];
		_unitat addItemCargoGlobal [_clacker,2];
		_unitat addItemCargoGlobal [_morfina,30];
		_unitat addItemCargoGlobal [_epinefrina,20];
		_unitat addItemCargoGlobal [_benes,40];
		_unitat addItemCargoGlobal [_bossaSang500,10];
		if (cc_mod_ace3 and cc_param_SistemaMedic == 1) then {
			_unitat addItemCargoGlobal [_atropina,30];
			_unitat addItemCargoGlobal [_benesElastiques,20];
			_unitat addItemCargoGlobal [_benesRapides,30];
			_unitat addItemCargoGlobal [_benesEmpaquetants,20];
			_unitat addItemCargoGlobal [_bossaSalina500,10];
		
			_unitat addItemCargoGlobal [_bossaPlasma500,10];
			
			_unitat addItemCargoGlobal [_kitQuirurgic,5];
			_unitat addItemCargoGlobal [_kitPrimersAuxilis,5];
		};
	};
};
