...
//                  slat                Líder d'esquadra amb RPG 26  (Squad Leader with RPG 26)          //
//                  tl                  Líder d'equip (Team Leader)                                      //
//                  tlat                Líder d'equip amb RPG 26  (Team Leader with RPG 26)              //
//                  rfl                 Fuseller (Rifleman)                                              //
//                  rflat               Fuseller amb RPG 26 (Rifleman with RPG 26)                       //
...
//                  amg                 Assitent de metrallador (Assistant Machine Gunner)               //
...
//                  mt                  Morter (Mortar)                                                  //
//                  amt                 Assistent de Morter (Assistant Mortar)                           //
//                  hmg                 Ametralladora Pesada (Heavy Machine Gun)                         //
//                  ahmg                Assistent d'Ametralladora Pesada (Assistant Heavy Machine Gun)   //
//                                                                                                       //
//                                                                                                       //
//                  mcase_s               Equipació Metal Case Small                                     //
//                  mcase_m               Equipació Metal Case Medium                                    //
//                  mcase_l               Equipació Metal Case Large                                     //
//                                                                                                       //
...
switch (_tipusUnitat) do
{
	...
	case "mcase_s":
	{
		...
		_unitat addMagazineCargoGlobal [_magArma,30];
		_unitat addMagazineCargoGlobal [_granada,10];
		_unitat addMagazineCargoGlobal [_granadaSMK_WHI,5];
		_unitat addMagazineCargoGlobal [_granadaSMK_BLA,10];
		_unitat addMagazineCargoGlobal [_granadaBEN_YEL,6];
		_unitat addMagazineCargoGlobal [_granadaBEN_RED,8];
		_unitat addMagazineCargoGlobal [_granadaBEN_GRE,4];
		_unitat addMagazineCargoGlobal [_granadaFLA_FAKEL,2];
		_unitat addMagazineCargoGlobal [_granadaFLA_FAKELS,10];
		_unitat addMagazineCargoGlobal [_granadaFLA_ZARYA,1];
		_unitat addMagazineCargoGlobal [_granadaFLA_PLAMYAM,3];
		_unitat addWeaponCargoGlobal [_pistolaB_GRE,2];
		_unitat addWeaponCargoGlobal [_pistolaB_RED,1];
		_unitat addWeaponCargoGlobal [_pistolaB_WHI,3];
		_unitat addItemCargoGlobal [_prismatic,2];
		_unitat addItemCargoGlobal ["tf_anprc154_1",2];
	};
	...
	case "mcase_m":
	{
		...
		_unitat addWeaponCargoGlobal [_armaAK103,1];
		_unitat addWeaponCargoGlobal [_armaSN,1];
		_unitat addItemCargoGlobal [_armaMiraB, 1];
		_unitat addItemCargoGlobal [_armaMira, 1];
		_unitat addItemCargoGlobal [_armaMira2,1];
		_unitat addItemCargoGlobal [_armaMiraSN, 1];
		_unitat addItemCargoGlobal [_armaSilenciador,1];
		_unitat addMagazineCargoGlobal [_magArma,40];
		_unitat addMagazineCargoGlobal [_magArmaSN,20];
		_unitat addMagazineCargoGlobal [_magArmaPISTOLA,3];
		_unitat addMagazineCargoGlobal [_granada,4];
		_unitat addMagazineCargoGlobal [_granadaSMK_WHI,3];
		_unitat addMagazineCargoGlobal [_granadaSMK_BLA,5];
		_unitat addMagazineCargoGlobal [_granadaBEN_YEL,3];
		_unitat addMagazineCargoGlobal [_granadaBEN_RED,2];
		_unitat addMagazineCargoGlobal [_granadaBEN_GRE,1];
		_unitat addMagazineCargoGlobal [_granadaFLA_FAKELS,2];
		_unitat addMagazineCargoGlobal [_granadaL,20];
		_unitat addMagazineCargoGlobal [_granadaL_FLA,4];
		_unitat addMagazineCargoGlobal [_granadaL_SMK_WHI,5];
		_unitat addMagazineCargoGlobal [_granadaL_SMK_GRE,4];
		_unitat addMagazineCargoGlobal [_granadaL_SMK_RED,6];
		_unitat addMagazineCargoGlobal [_granadaL_BEN_WHI,4];
		_unitat addMagazineCargoGlobal [_granadaL_BEN_GRE,1];
		_unitat addMagazineCargoGlobal [_granadaL_BEN_RED,2];
		_unitat addItemCargoGlobal [_prismatic_PDU4,1];
		_unitat addItemCargoGlobal ["tf_anprc148jem_1",1];
		_unitat addBackpackCargoGlobal [_motxillaRADIO,1];
		_unitat addItemCargoGlobal [_morfina,10];
		_unitat addItemCargoGlobal [_epinefrina,9];
		_unitat addItemCargoGlobal [_benes,15];
		_unitat addItemCargoGlobal [_bossaSang500,6];
		if (cc_mod_ace3 and cc_param_SistemaMedic == 1) then {
			_unitat addItemCargoGlobal [_atropina,8];
			_unitat addItemCargoGlobal [_benesElastiques,8];
			_unitat addItemCargoGlobal [_benesRapides,8];
			_unitat addItemCargoGlobal [_benesEmpaquetants,9];
			_unitat addItemCargoGlobal [_bossaSalina500,3];
	...
	case "mcase_l":
	{
		...
		_unitat addWeaponCargoGlobal [_armaMG,1];
		_unitat addWeaponCargoGlobal [_armaLlencador26,2];
		_unitat addWeaponCargoGlobal [_armaLlencadorAT,1];
		_unitat addWeaponCargoGlobal [_armaLlencadorAA,1];
		_unitat addItemCargoGlobal [_armaMiraMG, 1];
		_unitat addMagazineCargoGlobal [_magArmaMG,15];
		_unitat addMagazineCargoGlobal [_magLlencadorRPG7,6];
		_unitat addMagazineCargoGlobal [_magLlencadorRPG7_AT,1];
		_unitat addMagazineCargoGlobal [_magLlencadorRPG7_AP,4];
		_unitat addMagazineCargoGlobal [_magLlencadorRPG7_HE,2];
		_unitat addMagazineCargoGlobal [_magLlencadorAA,2];
		_unitat addBackpackCargoGlobal ["rhs_assault_umbts",1];
		_unitat addBackpackCargoGlobal ["rhs_sidor",1];
		_unitat addBackpackCargoGlobal [_motxillaAT,1];
	};
