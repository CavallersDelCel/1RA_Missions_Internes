...
onLoadName = "Operació Recaptura";            // Mission name.
onLoadMission = "Recaptura un especialista en explosius enemic";  // Brief mission description.
onLoadIntro = "1RA - Operació Recaptura";  // Message shown while loading introduction.
...
overviewText = "Torna a captur un especialista en explosius enemic.";          // Text shown when selecting mission.
