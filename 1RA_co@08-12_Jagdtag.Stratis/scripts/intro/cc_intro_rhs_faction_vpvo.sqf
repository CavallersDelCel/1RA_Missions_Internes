//=======================================================================================================//
// Arxiu: cc_intro_rhs_faction_vpvo.sqf                                                                  //
// Autor: CC_Magnetar                                                                                    //
// Versió: 0.1                                                                                           //
...
//             així com la data i la localització per la facció RHS: Soviet Air Defense Forces (Voyska   //
//             protivovozdushnoy oborony) "rhs_faction_vpvo":                                            //
//             http://class.rhsmods.org/rhsafrf/CfgFactionClasses_rhs_faction_vpvo.html                  //
// Canvis: 0.1 (2015/07/13) Versió inicial.                                                              //
//=======================================================================================================//
