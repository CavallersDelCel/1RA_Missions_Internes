...
cc_comu_requereix_dac         = 0;  // Variable per controlar l'ús del Dynamic-AI-Creator (DAC).
cc_comu_requereix_perfils1RA  = 2;  // Variable per controlar l'ús dels perfils de Virtual Arsenal del grup 1RA.
cc_comu_requereix_TFAR        = 1;  // Variable per controlar l'ús del Task Force Arrowhead Radio.
