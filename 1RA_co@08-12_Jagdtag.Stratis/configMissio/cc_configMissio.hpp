...
onLoadName = "Jagdtag: Dia de caça";                   // Nom de la missió (apareix en gran).
onLoadMission = "Localitzar i eliminar el traidor.";   // Descripció breu de la missió.
...
overviewText = "Un antic membre del servei d'espionatge ha desertat i ha venut informació classificada a les forces enemigues. Cal respondre amb contundència. Les comunicacions per ràdio no funcionen.";              // Text que es mostra al seleccionar la missó.
