class CfgCommunicationMenu
{
	class AH99
	{
		text = "Suport de AH-99"; // Text displayed in the menu and in a notification
	...
	class A164
	{
		text = "Suport de A-164"; // Text displayed in the menu and in a notification
		submenu = ""; // Submenu opened upon activation
	...
	class UAV
	{
		text = "Suport de UAV"; // Text displayed in the menu and in a notification
		submenu = ""; // Submenu opened upon activation
	...
	class PUAV
	{
		text = "Suport de AR-2 Darter"; // Text displayed in the menu and in a notification
		submenu = ""; // Submenu opened upon activation
	...
	class UGV
	{
		text = "Suport de UGV"; // Text displayed in the menu and in a notification
		submenu = ""; // Submenu opened upon activation
	...
	class AMMO
	{
		text = "Llancament de municio"; // Text displayed in the menu and in a notification
		submenu = ""; // Submenu opened upon activation
    ...
    class Artillery
    {
        text = "Atac d'artilleria"; // Text displayed in the menu and in a notification
    ...
    class Transport
    {
        text = "Helicopter de transport"; // Text displayed in the menu and in a notification
        submenu = ""; // Submenu opened upon activation (expression is ignored when submenu is not empty.)
