...
class RscButton {
	...
	colorBorder[] = {0,0,0,1};
	borderSize = 0.0;
	soundEnter[] = {__UI_Sound_Path(soundEnter),0.09,1};
	soundPush[] = {__UI_Sound_Path(soundPush),0.0,0};
	soundClick[] = {__UI_Sound_Path(soundClick),0.07,1};
	soundEscape[] = {__UI_Sound_Path(soundEscape),0.09,1};
	default = false;
};
