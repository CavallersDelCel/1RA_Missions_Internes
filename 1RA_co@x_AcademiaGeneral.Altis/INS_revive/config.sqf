...
INS_REV_CFG_list_of_respawn_locations_blufor = ["BASE","UH80_1","UH80_2"];
...
// Enable VAS function.
//
INS_REV_CFG_virtual_ammobox = false;		// Overrided by decription.ext parameter
INS_REV_CFG_loadout_on_respawn = false;		// Overrided by decription.ext parameter
INS_REV_CFG_vas_protect_ammobox = true;	// Overrided by decription.ext parameter
INS_REV_CFG_list_of_ammobox = [];

// Admin reserved slot
// You can reserve admin slot/
INS_REV_CFG_reserved_slot = false;
INS_REV_CFG_reserved_slot_units = ["admin"];

// LANGUAGE
// Language selection ("en" for english, you can create your own "XX_strings_lang.sqf" file)
INS_REV_CFG_language = "ca";
...
//
INS_REV_CFG_displayRespawnLocationMarker = false;	// Overrided by decription.ext parameter
...
//
INS_REV_CFG_half_dead_repsawn_player_body = false;	// Overrided by decription.ext parameter
...
// 2 is dead camera
//
INS_REV_CFG_JIP_Teleport_Action = 0;	// Overrided by decription.ext parameter
...
//
INS_REV_CFG_dom_repair = false;				// Overrided by decription.ext parameter
INS_REV_CFG_dom_repair_delay = 120;			// Overrided by decription.ext parameter
INS_REV_CFG_dom_repair_push_boat = false;		// Overrided by decription.ext parameter
INS_REV_CFG_dom_repair_flip_vehicle = false;	// Overrided by decription.ext parameter
...
// Enable Personal UAV
//
INS_REV_CFG_uav = false;					// Overrided by decription.ext parameter
...
INS_REV_CFG_uav_setting_dialog = false;		// Overrided by decription.ext parameter
INS_REV_CFG_uav_allow_map_click = false;		// Overrided by decription.ext parameter
...
//
INS_REV_CFG_s_nvg = false;	// Overrided by decription.ext parameter
...
INS_REV_CFG_player_marker_serverSide = false;	// Overrided by decription.ext parameter
