...
_IntON = _aircraft addaction ["<t color='#8080ff'>Llums interiors enceses","Scripts\Dix_Halo\IntLightON.sqf",[],20,false,true,"","[] call IntLight"];
_IntOff = _aircraft addaction ["<t color='#8080ff'>Llums interiors apagades","(_this select 0) setVariable ['Light_available',true,true]",[],2,false,true,"","[] call IntLight1"];