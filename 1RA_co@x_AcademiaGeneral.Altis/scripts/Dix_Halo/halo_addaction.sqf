...
(driver _C130) groupchat "Saltadors JA!";
hint "Jumpers Go";
_halo_action = _soldier addAction ["<t size='1.5' shadow='2' color='#00ffff'>SALT HALO!!!</t> <img size='4' color='#00ffff' shadow='2' image='\A3\Air_F_Beta\Parachute_01\Data\UI\Portrait_Parachute_01_CA.paa'/>", "call ghst_fnc_halo", [false,1000,60,true], 5, true, true, "","alive _target"];
