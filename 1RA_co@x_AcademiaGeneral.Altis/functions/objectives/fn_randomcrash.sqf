...
//create task
_tasktopic = format ["Locate %1 in %2", _veh_name,_locselname];
_taskdesc = format ["Locate the %1 in %2 and check for survivors", _veh_name,_locselname];
