...
if (_unitFaction == "blu_f") exitWith {
    ...
    // DEBUG OUTPUT
    if ( bmt_param_debugOutput == 1 ) then {
        player sideChat format ["DEBUG (bmt_acre2_configureLanguages.sqf): Using %1 for faction %2.", bmt_acre2_language_blufor, _unitFaction];
    };
};
...
if (_unitFaction in ["blu_g_f","ind_g_f","opf_g_f"]) exitWith {
    ...
    // DEBUG OUTPUT
    if ( bmt_param_debugOutput == 1 ) then {
        player sideChat format ["DEBUG (bmt_acre2_configureLanguages.sqf): Using %1 for faction %2.", bmt_acre2_language_fia, _unitFaction];
    };
};
...
if (_unitFaction == "opf_f") exitWith {
    ...
    // DEBUG OUTPUT
    if ( bmt_param_debugOutput == 1 ) then {
        player sideChat format ["DEBUG (bmt_acre2_configureLanguages.sqf): Using %1 for faction %2.", bmt_acre2_language_opfor, _unitFaction];
    };
};
...
if (_unitFaction == "ind_f") exitWith {
    ...
    // DEBUG OUTPUT
    if ( bmt_param_debugOutput == 1 ) then {
        player sideChat format ["DEBUG (bmt_acre2_configureLanguages.sqf): Using %1 for faction %2.", bmt_acre2_language_indfor, _unitFaction];
    };
};
...
if (_unitFaction == "civ_f") exitWith {
    ...
    // DEBUG OUTPUT
    if ( bmt_param_debugOutput == 1 ) then {
        player sideChat format ["DEBUG (bmt_acre2_configureLanguages.sqf): Using %1 for faction %2.", bmt_acre2_language_civ, _unitFaction];
    };
};
...
if (_unitFaction in ["rhs_faction_usarmy_wd", "rhs_faction_usarmy_d", "rhs_faction_usmc_wd", "rhs_faction_usmc_d", "rhs_faction_usn"] ) exitWith {
    ...
    // DEBUG OUTPUT
    if ( bmt_param_debugOutput == 1 ) then {
        player sideChat format ["DEBUG (bmt_acre2_configureLanguages.sqf): Using %1 for faction %2.", bmt_acre2_language_rhsusaf, _unitFaction];
    };
};
...
if (_unitFaction in ["rhs_faction_vpvo", "rhs_faction_vdv"] ) exitWith {
    ...
    // DEBUG OUTPUT
    if ( bmt_param_debugOutput == 1 ) then {
        player sideChat format ["DEBUG (bmt_acre2_configureLanguages.sqf): Using %1 for faction %2.", bmt_acre2_language_rhsafrf, _unitFaction];
    };
};
...
if (_unitFaction == "bwa3_faction" ) exitWith {
    ...
    // DEBUG OUTPUT
    if ( bmt_param_debugOutput == 1 ) then {
        player sideChat format ["DEBUG (bmt_acre2_configureLanguages.sqf): Using %1 for faction %2.", bmt_acre2_language_bwa3, _unitFaction];
    };
};
