...
switch (_unitFaction) do {
    ...
    case "rhs_faction_usmc_d": {
        ...
        _uavMarkerType = [
            ...
            ["\a3\ui_f\data\map\markers\military\objective_ca.paa", EAST call BIS_fnc_sideColor, markerPos "markerRescue", 1, 1, 0, "Rescatar els marines", 0]
        ];
	};
