...
onLoadMission = "Rescatar els marines supervivents.";  // Brief mission description.
...
overviewText = "Després de l'atac a les tropes en retirada, les forces aliades han decidit reintensificar les operacions a Kunduz per tal de donar un missatge clar a les forces insurgents: cap atac quedarà sense resposta! L'objectiu és rescatar els pocs soldats supervivents i eliminar qualsevol informació confidencial que hagin pogut obtenir mitjançant la tortura.";          // Text shown when selecting mission.
