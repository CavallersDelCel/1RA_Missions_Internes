...
onLoadName = "Vergeltung ";                            // Nom de la missió (apareix en gran).
onLoadMission = "Evitar que el CSAT capturi el HQ.";   // Descripció breu de la missió.
...
overviewText = "Dos equips de foc han de dur a terme tasques independents per tal de col·laborar en la defensa del campament aliat enfront un atac enemic. Els equips de foc tenen cobertura i evacuació aèria.";              // Text que es mostra al seleccionar la missó.
