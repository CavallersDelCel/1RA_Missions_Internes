...
if ((_grupUnitat select 0 != "nil") and (_grupUnitat select 1 != -1)) then {
    ...
    if ((_tipusUnitat in cc_var_llistaRadioOficials) or (_tipusUnitat in cc_var_llistaRadioSoldats)) then {
        _canal = 0;
        {
        ...
        if (_tipusUnitat in cc_var_llistaRadioOficials) then {
    ...
    if (_tipusUnitat in cc_var_llistaRadioRTO) then {
