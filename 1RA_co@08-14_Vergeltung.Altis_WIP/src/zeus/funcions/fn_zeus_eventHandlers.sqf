...
{
    _x addEventHandler ["CuratorGroupPlaced",{ _this remoteExec ["cc_fnc_zeus_afegirGrups", 2, false] }];
    _x addEventHandler ["CuratorObjectPlaced",{ _this remoteExec ["cc_fnc_zeus_afegirObjectes", 2, false] }];
} forEach allCurators;
