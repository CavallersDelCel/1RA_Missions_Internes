...
onLoadName = "Ràpid i dur";            // Mission name.
onLoadMission = "Elimina un oficial i rescata un civil";  // Brief mission description.
onLoadIntro = "1RA - Ràpid i dur";  // Message shown while loading introduction.
