...
_quotes = ["Em dic Zeus, si Zeus, com el pare d'Apol·lo, el del mont Olimp, el de no em toquis els collons que et fico un llamp pel cul, Zeus!, et sembla malament o que?.\nZeus Carver - Die Hard 3"];

_missionName = "Ràpid i dur";
...
switch (_unitFaction) do {
    ...
    case "blu_f": {
        _missionLocation = "Sud-est d'Altis, base del 1er Regiment Aerotransportat";
