...
// JIP support                                                                                           //
//=======================================================================================================//
#define BMT_JIP_TIME 1 // 0 = JIP always enabled, 1 = 5 min, 2 = 10 min, 3 = 15 min, 4 = 20 min, 5 = 25 min, 6 = 30 min.

//=======================================================================================================//
// RESPAWN                                                                                               //
//=======================================================================================================//
#define BMT_RESPAWN_NUMTICKETS_CONFIG 2    // 0 = Unlimited, 1 = No tickets, 2 = Mission based.
#define BMT_RESPAWN_NUM_ALLOWED_RESPAWNS 1 // Number of allowed respawns = Number of tickets - 1. Therefore,
                                           // if a maximum of 2 respawns is desired, the number of tickets
                                           // has to be 3.
