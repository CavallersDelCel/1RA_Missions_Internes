...
onLoadName = "Home sweet home ...";                    // Nom de la missió (apareix en gran).
onLoadMission = "Un grup de marines tornen cap a casa.";    // Descripció breu de la missió.
...
overviewText = "Un grup de marines tornen cap a casa després de servir a Kunduz, Afghanistan.";              // Text que es mostra al seleccionar la missó.
