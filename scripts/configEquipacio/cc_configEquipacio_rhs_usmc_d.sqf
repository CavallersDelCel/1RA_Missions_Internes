//=======================================================================================================//
// Arxiu: cc_configEquipacio_rhs_usmc_d.sqf                                                              //
// Autor: CC_Magnetar                                                                                    //
// Versió: 0.5                                                                                           //
...
switch (_tipusUnitat) do
{
    ...
    default {
        _unitat sideChat format ["DEBUG (cc_configEquipacio_rhs_usmc_d.sqf): el tipus d'unitat %1 no està definit. Utilitzant l'equipació de fuseller.", _tipusUnitat];
