...
puntsDesti = [["tirmg_teleport_mark", "tirat_teleport_mark", "tirlg_teleport_mark"],
              ["tir_teleport_mark", "tirat_teleport_mark", "tirlg_teleport_mark"],
              ["tir_teleport_mark", "tirmg_teleport_mark", "tirlg_teleport_mark"],
              ["tir_teleport_mark", "tirmg_teleport_mark", "tirat_teleport_mark"]
             ];
puntsInici = [tir_teleport, tirmg_teleport, tirat_teleport, tirlg_teleport];
