...
private["_monitorHuntIR", "_granadaHuntIR"];
...
_armaSNSilenciador = "rhsusf_acc_M2010S";
...
if (cc_mod_ace3) then {
    ...
    // Objectes relacionats amb HuntIR.
    _monitorHuntIR = "ACE_HuntIR_monitor";
    _granadaHuntIR = "ACE_HuntIR_M203";
...
switch (_tipusUnitat) do
{
    ...
    case "me": {
        ...
        if (cc_mod_ace3 or cc_mod_agm) then {
            ...
            if (cc_mod_ace3 and cc_param_sistemaMedic == 2) then {
                ...
                (unitBackpack _unitat) addItemCargoGlobal [__bossaSang500,2];
                (unitBackpack _unitat) addItemCargoGlobal [__bossaPlasma500,2];
    ...
    case "sn": {
        ...
        (uniformContainer _unitat) addItemCargoGlobal [_armaSNSilenciador,1];
    ...
    case "hmmwv1": {
        ...
        _unitat addMagazineCargoGlobal ["rhsusf_100Rnd_762x51",10];
        ...
        if (cc_mod_ace3 or cc_mod_agm) then {
            ...
            _unitat addMagazineCargoGlobal [_granadaHuntIR,1];
            _unitat addItemCargoGlobal [_monitorHuntIR,1];
            if (cc_mod_ace3 and cc_param_sistemaMedic == 2) then {
    ...
    case "hmmwv3": {
        ...
        _unitat addMagazineCargoGlobal ["rhs_mag_30Rnd_556x45_M855A1_Stanag",10];
        _unitat addMagazineCargoGlobal ["rhs_mag_m67",5];
        _unitat addMagazineCargoGlobal ["rhsusf_5Rnd_300winmag_xm2010",10];
        _unitat addMagazineCargoGlobal ["rhsusf_20Rnd_762x51_m118_special_Mag",6];
        if (cc_mod_ace3 or cc_mod_agm) then {
            _unitat addItemCargoGlobal [_morfina,5];
            _unitat addItemCargoGlobal [_epinefrina,5];
            _unitat addItemCargoGlobal [_benes,5]; 
            if (cc_mod_ace3 and cc_param_sistemaMedic == 2) then {
                _unitat addItemCargoGlobal [_atropina,5];
                _unitat addItemCargoGlobal [_benesElastiques,5];
